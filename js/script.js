var goodsList = [{
		id: 1234564876,
		imgUrl: '../images/1.jpg',
		goodsInfo: '花花公子衬衫男2020秋季新款港风ins格子衬衫男士长袖韩版潮流帅气外套休',
		goodsParams: '红灰 L',
		price: 199,
		goodsCount: 1,
	...
	},
	{
		id: 1234564876,
		imgUrl: '../images/3.jpg',
		goodsInfo: '索尼(SONY) DSC-W800 便携数码相机/照相机/卡片机黑色(约2010万',
		goodsParams: '黑色 W800',
		price: 399,
		goodsCount: 1,
...
function loadGoods() {
	$.each(goodsList, function(i, item) {
		var goodsHtml = '<div class="goods-item" onclick="fa()">' +
...
var num = document.getElementById('deleteMulty')
var num2 = document.querySelector('.goods-content');
num.onclick = function fser() {
...
var num4 =document.querySelector('.item-delete')
var bod = document.querySelector('.goods-item')

num4.onclick = function fa() {
